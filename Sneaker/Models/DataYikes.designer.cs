...
namespace Sneaker.Models
{
	...
	public partial class ThuongHieu : INotifyPropertyChanging, INotifyPropertyChanged
	{
        ...
        private string _LogoThuongHieu;
    ...
    partial void OnTenThuongHieuChanged();
        ...
        [global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_LogoThuongHieu", DbType = "Nchar(10) NULL", CanBeNull = false)]
        public string LogoThuongHieu
        {
            get
            {
                return this._LogoThuongHieu;
            }
            set
            {
                if ((this._LogoThuongHieu != value))
                {
                    this.OnLogoThuongHieuChanging(value);
                    this.SendPropertyChanging();
                    this._LogoThuongHieu = value;
                    this.SendPropertyChanged("LogoThuongHieu");
                    this.OnLogoThuongHieuChanged();
                }
            }
        }

        private void OnLogoThuongHieuChanged()
        {
            throw new NotImplementedException();
        }

        private void OnLogoThuongHieuChanging(string value)
        {
            throw new NotImplementedException();
        }
